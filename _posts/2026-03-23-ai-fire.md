...
I remember when [ChatGPT](LINK) first stormed the ramparts back in 2022.  I felt great apprehension, that they would steal my creativity and render myself just a stick of meat.
...
3. [Github Copilot](https://github.com/copilot)
...
(I ultimately got an [Amazfit Band 7](https://www.amazon.com/Amazfit-Fitness-Tracker-Monitoring-Resistant/dp/B09Z6CRHJ6/ref=nosim?tab=distractedfor-2))
...
Out of that thought, the [Screamsheet](https://github.com/peterjmartinson/screamsheet) was born.

Really, I had GitHub Copilot write the program for me.  It's since expanded from baseball scores to hockey scores, MLB news, and political news (for Dad).  I even have the Grok API summarize games for me.  You can see the code [here](https://github.com/peterjmartinson/screamsheet).
